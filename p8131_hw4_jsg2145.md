...
```
    ...
    ## Call:
    ## multinom(formula = cbind(low, med, high) ~ hous_tp + conx, data = df_sum)
    ## 
    ## Coefficients:
    ##      (Intercept) hous_tphous hous_tptr_bk    conxlow
    ## med   -0.2180364  0.06967922    0.4067631 -0.2959832
    ## high   0.2474047 -0.30402275    0.6415948 -0.3282264
    ## 
    ## Std. Errors:
    ##      (Intercept) hous_tphous hous_tptr_bk   conxlow
    ## med   0.10930968   0.1437749    0.1713009 0.1301046
    ## high  0.09783068   0.1351693    0.1500774 0.1181870
    ## 
