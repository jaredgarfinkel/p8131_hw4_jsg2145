...
```
    ...
    ## # A tibble: 6 x 7
    ## # Groups:   conx [2]
    ##   conx  hous_tp   low   med  high log_odds log_odds2
    ##   <chr> <chr>   <dbl> <dbl> <dbl>    <dbl>     <dbl>
    ## 1 high  apt     0.315 0.259 0.426   -0.778     0.297
    ## 2 high  hous    0.383 0.310 0.307   -0.475     0.815
    ## 3 high  tr_bk   0.188 0.260 0.552   -1.46     -0.211
    ## 4 low   apt     0.410 0.240 0.350   -0.364     0.618
    ## 5 low   hous    0.379 0.271 0.350   -0.496     0.618
    ## 6 low   tr_bk   0.297 0.247 0.457   -0.863     0.174
