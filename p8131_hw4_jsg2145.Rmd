...
The odds ratio of reporting medium satisfaction compared to low satisfaction is `r filter(tidy.multi, rownames == "high", name == "conxlow") %>% pull(coef) %>% round(digits = 3) %>% exp()` CI95%: (`r filter(tidy.ci, sat == "high", par == "conxlow") %>% pull(lower) %>% round(digits = 3) %>% exp()`, `r filter(tidy.ci, sat == "high", par == "conxlow") %>% pull(upper) %>% round(digits = 3) %>% exp()`) for people who reported low contact compared to those who reported high contact holding housing type constant.

The odds ratio of reporting medium satisfaction compared to low satisfaction is `r filter(tidy.multi, rownames == "high", name == "hous_tphous") %>% pull(coef) %>% round(digits = 3) %>% exp()` CI95%: (`r filter(tidy.ci, sat == "high", par == "hous_tphous") %>% pull(lower) %>% round(digits = 3) %>% exp()`, `r filter(tidy.ci, sat == "high", par == "hous_tphous") %>% pull(upper) %>% round(digits = 3) %>% exp()`) for people who live in houses compared to those who live in apartments holding contact constant.

The odds ratio of reporting medium satisfaction compared to low satisfaction is `r filter(tidy.multi, rownames == "high", name == "hous_tptr_bk") %>% pull(coef) %>% round(digits = 3) %>% exp()` CI95%: (`r filter(tidy.ci, sat == "high", par == "hous_tptr_bk") %>% pull(lower) %>% round(digits = 3) %>% exp()`, `r filter(tidy.ci, sat == "high", par == "hous_tptr_bk") %>% pull(upper) %>% round(digits = 3) %>% exp()`) for people who live in tower blocks compared to those who live in apartments holding contact constant.
